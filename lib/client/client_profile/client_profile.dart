  ...
  void fetchProfileData() async {
    try {
      ...
      final response = await http.post(
        Uri.parse("https://sparkling-sarong-bass.cyclic.app/customer/signin/profile"),
  ...
  void _updateProfile() async {
    ...
    try {
      final response = await http.put(
        Uri.parse("https://sparkling-sarong-bass.cyclic.app/customer/signin/update_profile"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(_profileData!["name"],style: const TextStyle(color: Colors.white),),
